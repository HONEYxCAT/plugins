            ...
            var observer = new MutationObserver(function (mutations) {
                ...
                for (var i = 0; i < mutations.length; i++) {
                    ...
                    for (var j = 0; j < m.addedNodes.length; j++) {
                        ...
                        if (
                            node.matches &&
                            (node.matches(".search__keypad") ||
                                node.matches(".search") ||
                                node.querySelector(".search__keypad") ||
                                node.querySelector("#orsay-keyboard") ||
                                node.querySelector(".simple-keyboard-mic"))
                        ) {
                            changed = true;
                            break;
                        }
                ...
                if (typeof Lampa.SettingsApi.addParam === "function") {
                    Lampa.SettingsApi.addParam({
                        ...
                        field: {
                            name: PLUGIN_NAME,
                            description:
                                "Скрывает кнопку голосового поиска и устанавливает фокус в строку поиска при открытии.",
                        },
                    });
                }
            }
