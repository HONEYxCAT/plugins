    ...
    var TIZEN_FIX = {
        ...
        hook: function () {
            ...
            if (!window.$ || !window.$.ajax) {
                return setTimeout(function () { _this.hook() }, 200);
            }
            ...
            window.$.ajax = function (url, options) {
                ...
                if (match) {
                    ...
                    // Фильтруем по ID. Можно убрать условие, если хотите для всех.
                    // Пока оставим для безопасности.
                    // 127532 = Solo Leveling
                    var allowedIds = ['127532']; 
                    
                    // Если ID в списке ИЛИ мы просто хотим тестировать на всех аниме:
                    // (Раскомментируйте if ниже и удалите проверку allowedIds если хотите на все)
                    if (allowedIds.indexOf(tvId) !== -1) {
        ...
        process: function (data, requestedSeason, tvId) {
            ...
            allEps.sort(function (a, b) { return a.episode_number - b.episode_number; });
