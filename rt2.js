...
if(needclick){
var needclick_div = $('<div class="player-video__youtube-needclick"><img src="https://rutube.ru/api/video/' + id + '/thumbnail/?redirect=1" /><div></div></div>');
object.append(needclick_div);
needclick_div.on('click', function(){
needclick = false;
rutube.playVideo();
needclick_div.remove();
clearTimeout(timetapplay);
});
timetapplay = setTimeout(function(){
needclick_div.find('div').text(Lang.translate('player_youtube_start_play'));
},10000);
}
