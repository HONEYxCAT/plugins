(function () {
	...
	// === ВСПОМОГАТЕЛЬНЫЕ КЛАССЫ ЭКРАНА И ИНФО-БЛОКА ===
	function InfoBlock() {
		var html;
		var timer;
	...
	function component(object) {
		...
		var active = 0;
		var newlampa = Lampa.Manifest && Lampa.Manifest.app_digital >= 166; // безопасная проверка
		var info;
		var lezydata;
	...
	function startPlugin() {
		...
		Lampa.Template.add(
			...
			'\n<style>\n' +
				...
				'.new-interface-info__title{font-size:4em;font-weight:600;margin-bottom:.3em;overflow:hidden;-o-text-overflow:".";text-overflow:".";display:-webkit-box;-webkit-line-clamp:1;line-clamp:1;-webkit-box-orient:vertical;margin-left:-.03em;line-height:1.3}\n' +
				...
				'.new-interface-info__description{font-size:1.2em;font-weight:300;line-height:1.5;overflow:hidden;-o-text-overflow:".";text-overflow:".";display:-webkit-box;-webkit-line-clamp:4;line-clamp:4;-webkit-box-orient:vertical;width:70%}\n' +
		...
		// Класс на body, чтобы стили сразу применялись
		$("body").addClass("new-interface");

		// Следим за жизненным циклом активити и удерживаем класс
		Lampa.Listener.follow("activity", function (e) {
			if (e.type === "start") $("body").addClass("new-interface");
			if (e.type === "stop") $("body").addClass("new-interface"); // не снимаем, хотим глобальный эффект
		});

		// Регистрируем компонент, чтобы его можно было открыть из других мест
