...
RT.Player.prototype = {
	...
	createIframe: function() {
		...
		// FIX: Всегда включаем autoplay, так как Lampa управляет стартом
		...
		// FIX: Добавлены необходимые разрешения для современных браузеров и ТВ (encrypted-media обязателен)
		iframe.setAttribute('allow', 'autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock; clipboard-write');
